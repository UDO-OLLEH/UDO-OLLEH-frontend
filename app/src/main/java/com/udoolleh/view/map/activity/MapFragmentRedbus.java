...
public class MapFragmentRedbus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_map_bus_red);
        ...
        edit_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MapFragmentRedbus.this, UserEditProfile.class);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MapFragmentRedbus.this);
                builder.setTitle("우도올레")
                        ...
                        .setPositiveButton("로그아웃", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                new LogoutResponse();
                                Toast.makeText(MapFragmentRedbus.this, "로그아웃 되었습니다.", Toast.LENGTH_LONG).show();
